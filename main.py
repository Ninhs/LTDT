...
tk.Label(frame_vertices, text="Đỉnh đầu:").grid(row=0, column=0, sticky="w", padx=5, pady=5)
start_vertex = ttk.Combobox(frame_vertices, values=["1","2","3","4","5"])
start_vertex.grid(row=1, column=0, padx=5, pady=5)

tk.Label(frame_vertices, text="Đỉnh đích:").grid(row=0, column=1, sticky="w", padx=5, pady=5)
end_vertex = ttk.Combobox(frame_vertices, values=["1","2","3","4","5"])
end_vertex.grid(row=1, column=1, padx=5, pady=5)

tk.Button(frame_vertices, text="Tìm đường đi").grid(row=1, column=2, padx=10, pady=5)
...
btn_add_edge.grid(row=3, column=0, columnspan=3,sticky="we", padx=5, pady=35)
...
tk.Button(frame_add, text="Thêm đỉnh", command=controller.enable_add_vertex).grid(row=4, column=0, columnspan=3, sticky="we", padx=5, pady=45)
